      ...
      <div className={styles.inner}>
        <div className={styles.grid}>
          ...
          <div className={styles.imageCol}>
            <div className={styles.imageBox} role="img" aria-label="Máy theo dõi sản khoa L8D">
              <img 
                src={l8d[0]} 
                alt={PRODUCT.name} 
            ...
            <div role="tabpanel">
              {activeTab === 'specs' ? (
                ...
                <div className={styles.advantages}>
                  <p><strong>Thiết bị theo dõi sản khoa đáng tin cậy cho phòng khám và bệnh viện</strong></p>
                  <ul className={styles.specsList}>
